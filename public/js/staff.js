  ...
  data: {
    staff: [
      ...
      },
      {
        ...
        area: ['battery'],
        bio: 'Zac is a private lesson instructor and freelance drumline teacher and arranger.  Zac is the founder and director of and the Dayton Dragons MLB Drumline. He graduated from Miami University in December 2012 with a Bachelor\'s Degree in Music Education.  At Miami University, Zac played in the Percussion Ensemble, Wind Ensemble, Symphony Orchestra, Symphony Band, Global Rhythms ensemble, and Steel Band.  He has performed with and learned from several artists such as Dr. William Albin, Jeff Queen, Dr. Chris Tanner, Bob Becker, and Srinivas Krishnan.<br><br>While attending school, Zac has performance and teaching experience with arguably some of the most elite groups in the marching arts. Zac played snare drum for 2013 WGI Gold Medalist Rhythm X and DCI 2012 Silver Medalist Carolina Crown, as well as serving as drum captain for the Miami University Marching Band.  Zac is recipient of several awards including the Friends of DCI Scholarship, the Lacey/Striple Highland Band and Drum Scholarship, and KKΨ most inspirational band member award.<br><br>In the past, Zac performed with the Cincinnati Bengals “Growl” Drumline. He directed and arranged for WGI scholastic open finalist Kettering Fairmont HS. Currenly, Zac is the batterie coordinator at Cap City and the Colts Drum and Bugle Corps.  Additionally, he is the Percussion GA at Miami University for the 2016-2017 school year.'
      },
      {
        name: 'Corey Cutler',
